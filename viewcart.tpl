...
<link type="text/css" href="/themes/cart/BeeCart/assets/js/toastr/build/toastr.min.css?v={$Ver}"
	rel="stylesheet" />
<script src="/themes/cart/BeeCart/assets/js/toastr/build/toastr.min.js?v={$Ver}"></script>
<script src="/themes/cart/BeeCart/assets/js/viewcart.js?v={$Ver}"></script>
<style>
/* 购物车整体样式 */
.cart-wrapper {
	background: #fff;
...
.cart_qty .number:focus {
	border-color: #316eea;
	box-shadow: 0 0 0 3px rgba(49,110,234,0.1);
}
						...
						{if $Userinfo.user.credit > 0}
							<div class="checkboxDiv">	
								...
								<span class="mr-1" style="margin-left: 35px;">
									<img width="20" src="/themes/clientarea/BeeCart/assets/images/gold.svg" alt="">
								</span>
						...
						{if !empty($client.is_open_credit_limit) && $client.credit_limit_balance >= $ShopData.total_price && $is_open_shd_credit_limit}
							<div class="checkboxDiv">
								...
								<span class="mr-1" style="margin-left: 35px;padding-bottom:5px;">
									<img width="20" src="/themes/clientarea/BeeCart/assets/images/CreditCard.png" alt="">
								</span>
