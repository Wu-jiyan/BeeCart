...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    render: function (init) {
      ...
      // If the select doesn't have a title, then use the BeeCart, or if nothing is set at all, use noneSelectedText
      ...
      var that = this,
          ...
          getPlacement = function ($element) {
            var containerPosition = {},
                // fall back to dropdown's BeeCart display setting if display is not manually set
  ...
  function Plugin (option) {
    ...
    if (version.major === '4') {
      ...
      classNames.ICONBASE = '';
      classNames.TICKICON = 'bs-ok-BeeCart';
