<style>
	...
	input[type="range"]::-webkit-slider-thumb {
		...
		border-radius: 0;
		box-shadow: 0 2px 8px rgba(43,109,229,0.25);
	}
...
<form id="addCartForm" method="post" class="needs-validation configoption_form" novalidate
						...
						<div class="form-group row configureproduct">
							...
							<div class="form-group row configureproduct">
								...
								<div class="col-md-3">
									<select id="config{$option.id}" name="configoption[{$option.id}]"
										class="form-control selectpicker configoption_os selectpicker_refresh" data-style="btn-BeeCart">
										...
										<option id="sub{$sub.id}" value="{$sub.id}" {if
											...
											<select class="form-control configoption_os_group selectpicker" data-style="btn-BeeCart"
								...
								<div class="col-md-3">
									<select id="config{$option.id}" name="configoption[{$option.id}]"
										...
										data-os-selected="{$getUrlConfig.config_options[$option.id]}" {/if} data-style="btn-BeeCart">
							...
							<div class="form-group row configureproduct">
								...
								<div class="col-md-10">
									...
									<select id="config{$option.id}" name="configoption[{$option.id}]"
										class="form-control col-md-3 selectpicker" data-style="btn-BeeCart">
										{foreach $option.sub as $sub_key=>$sub_val}
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<select id="customfield[{$custom_fields.id}]" name="customfield[{$custom_fields.id}]"
									class="form-control selectpicker" data-style="btn-BeeCart" {if $custom_fields.required}required{/if}>
	...
	<!-- select -->
	<link rel="stylesheet"
		href="/themes/cart/BeeCart/assets/js/bootstrap-select/css/bootstrap-select.min.css?v={$Ver}">
	<script src="/themes/cart/BeeCart/assets/js/bootstrap-select/js/bootstrap-select.min.js?v={$Ver}"></script>
	<!-- slider -->
	<link rel="stylesheet"
		href="/themes/cart/BeeCart/assets/js/ion-rangeslider/css/ion.rangeSlider.min.css?v={$Ver}">
	<script src="/themes/cart/BeeCart/assets/js/ion-rangeslider/js/ion.rangeSlider.min.js?v={$Ver}"></script>
	<script>
		// 密码重置
		var pwdRule = {
	...
	<script src="/themes/cart/BeeCart/assets/js/configureproduct.js?v={$Ver}"></script>
	<!-- 滑块禁用区域 -->
	<script>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$('.configureproduct').hover(
				function() {
					$(this).find('.col-form-label').css('color', '#316eea');
				},
				function() {
					$(this).find('.col-form-label').css('color', '#64748b');
				}
			);
